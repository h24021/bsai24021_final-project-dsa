...
void seedSampleData(Library& library) {
    ...
    User user1(1001, "Alice Johnson", "alice@library.com", "librarian");
    library.addUser(user1);
    
    User user2(1002, "Bob Smith", "bob@library.com", "member");
    library.addUser(user2);
    
    User user3(1003, "Carol Davis", "carol@library.com", "member");
    library.addUser(user3);

    library.borrowBook(1002, 101);  
    library.borrowBook(1002, 103);  
    library.borrowBook(1003, 109);  
...
void runApiTests(Router& router) {
    ...
    cout << "Status: " << static_cast<int>(res1.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res2.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res3.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res4.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res5.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res6.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res7.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res8.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res9.getStatusCode()) << "\n";
    ...
    cout << "Status: " << static_cast<int>(res10.getStatusCode()) << "\n";
